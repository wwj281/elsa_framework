...
n_chip = 4
prefetch_size = 16 
n_mac = 16  # mac的数量就是一个物理bank一次能处理的操作数数量，在16bit DQ下，也等于BL
...
def main():
    ...
    parser.add_argument("-tn", "--token_num", type=int, default=653,
